  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (bookImage) {
        ...
        const uploadResponse = await axios.post('https://book-review-platform-mern.vercel.app/api/v1/upload', formData, {
          headers: {
      ...
      if (JWT) {
        ...
        const submitResponse = await axios.post('https://book-review-platform-mern.vercel.app/api/v1/createNewBook', data);
